...
export function installFinalLayers(map: MapLibreMap, user: UserLocation | null, onOne: (project: MapProject) => void, onMany: (projects: MapProject[]) => void) {
  ...
  map.addLayer({ id: "final-mask", type: "fill", source: SOURCES.mask, paint: { "fill-color": "#020705", "fill-opacity": 0.72 } });
  map.addLayer({ id: "final-edge", type: "line", source: SOURCES.edge, paint: { "line-color": "rgba(217,255,97,0.62)", "line-width": 1.5, "line-dasharray": [3, 3] } });
  ...
  map.addLayer({ id: "final-clusters", type: "circle", source: SOURCES.points, filter: ["has", "point_count"], paint: { "circle-color": "#101a16", "circle-radius": ["step", ["get", "point_count"], 15, 10, 19, 50, 24, 200, 29], "circle-stroke-color": "#d9ff61", "circle-stroke-width": 2.1, "circle-opacity": 0.98 } });
  ...
  map.addLayer({ id: "final-points", type: "circle", source: SOURCES.points, filter: ["all", unclustered, exact], paint: { "circle-radius": ["interpolate", ["linear"], ["zoom"], 7, 4.5, 12, 6.2, 15, 8], "circle-color": categoryColor, "circle-opacity": 0.96, "circle-stroke-color": "#101416", "circle-stroke-width": 1.5 } });
